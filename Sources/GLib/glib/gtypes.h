...
#error "Only <glib/glib.h> can be included directly."
#endif
 ...
 */
#define GUINT16_SWAP_LE_BE_CONSTANT(val) ((guint16) ((guint16) ((guint16) (val) >> 8) | \
...
#define GUINT64_SWAP_LE_BE_CONSTANT(val) ((guint64) ((((guint64) (val) &                                     \
...
#define GUINT32_SWAP_LE_PDP(val) ((guint32) ((((guint32) (val) & (guint32) 0x0000ffffU) << 16) | \
                                             (((guint32) (val) & (guint32) 0xffff0000U) >> 16)))
#define GUINT32_SWAP_BE_PDP(val) ((guint32) ((((guint32) (val) & (guint32) 0x00ff00ffU) << 8) | \
...
_GLIB_CHECKED_ADD_UINT (guint *dest, guint a, guint b)
{
  *dest = a + b;
  return *dest >= a;
}
static inline gboolean
_GLIB_CHECKED_MUL_UINT (guint *dest, guint a, guint b)
{
  *dest = a * b;
  return !a || *dest / a == b;
}
static inline gboolean
_GLIB_CHECKED_ADD_UINT64 (guint64 *dest, guint64 a, guint64 b)
{
  *dest = a + b;
  return *dest >= a;
}
static inline gboolean
_GLIB_CHECKED_MUL_UINT64 (guint64 *dest, guint64 a, guint64 b)
{
  *dest = a * b;
  return !a || *dest / a == b;
}
static inline gboolean
_GLIB_CHECKED_ADD_SIZE (gsize *dest, gsize a, gsize b)
{
  *dest = a + b;
  return *dest >= a;
}
static inline gboolean
_GLIB_CHECKED_MUL_SIZE (gsize *dest, gsize a, gsize b)
{
  *dest = a * b;
  return !a || *dest / a == b;
}
