...
#error "Only <glib/glib-object.h> can be included directly."
#endif
 ...
 * Since: 2.70
 */
#define G_DEFINE_FINAL_TYPE_WITH_CODE(TN, t_n, T_P, _C_)                   \
  _G_DEFINE_TYPE_EXTENDED_BEGIN (TN, t_n, T_P, G_TYPE_FLAG_FINAL) { _C_; } \
  _G_DEFINE_TYPE_EXTENDED_END ()                                           \
